...
def group_collide( group_set, other_object ) :
    ...
    for sprite in group_set :
        # Does Sprite object collide with Ship
        if ( sprite.collide( other_object ) == True ) :
            collision = True
            print "collision"
            # Collision - so remove Sprite from group_set
    return collision   
...
class Sprite:
    ...
    def collide(self, other_object) :
        distance = dist( self.get_posn(), other_object.get_posn() )
        print distance
...
rock_group = set([])    # Empty rock collection set
